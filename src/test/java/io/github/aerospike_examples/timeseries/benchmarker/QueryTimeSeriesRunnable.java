...
class QueryTimeSeriesRunnable extends TimeSeriesRunnable {
    ...
    public QueryTimeSeriesRunnable(AerospikeClient asClient, String asNamespace, String asSet,
    ...
    public void run() {
        ...
        while (System.currentTimeMillis() - startTime < runDurationSeconds * Constants.MILLISECONDS_IN_SECOND) {
            ...
            timeSeriesClient.runQuery(timeSeriesInfo.getSeriesName(), QueryOperation.AVG,
    ...
    static String timeSeriesInfoSummary(Vector<TimeSeriesInfo> timeSeriesInfoVector) {
        ...
        for (TimeSeriesInfo timeSeriesInfo : timeSeriesInfoVector)
            avgDataPointCount += timeSeriesInfo.getDataPointCount();
